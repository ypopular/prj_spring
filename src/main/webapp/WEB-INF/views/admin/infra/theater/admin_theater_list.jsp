...
<html lang="ko">
    ...
    <ul class="cinema_name_alter_list">
        ...
        <button type="button" id="list_save_btn2"><a href="admin_theater_list_form?seq=<c:out value="${list.seq}"/>">변경</a></button>
            ...
            <button type="button" class="theater_add_go" id="go_insert">
                <a href="admin_theater_list_form?cinema_name_seq=<c:out value="${list.cinema_name_seq}"/>">상영관 추가</a>
            </button>
        </c:if> --%>

 <button type="button" id="go_insert">
               <a href="admin_theater_list_form?cinema_name_seq=<c:out value="${seq1}"/>">상영관 추가</a>
            </button>
