                   ...
                   <select>
                    ...
                    <div id="theater_alter_small_wrap">
                        ...
                        <ul class="theater_alter_list">
                         ...
                         <ul class="theater_alter_list">
                		  <li><input type="text" class="form-control" id="seq" name="seq" placeholder="seq" required readonly value="<c:out value="${itme.seq}"/>"></li>
 						  <li><input type="text" class="form-control" id="id" name="id" placeholder="id" required value="<c:out value="${itme.id}"/>"></li>
 						  <li><input type="text" class="form-control" id="password" name="password" placeholder="password" required value="<c:out value="${itme.password}"/>"></li>
 						   <li><input type="text" class="form-control" id="gender" name="gender" placeholder="gender" required value="<c:out value="${itme.gender}"/>"></li>
 						    <li><input type="text" class="form-control" id="tel" name="tel" placeholder="tel" required value="<c:out value="${itme.tel}"/>"></li>
 						     <li><input type="text" class="form-control" id="tel_type" name="tel_type" placeholder="tel_type"required value="<c:out value="${itme.tel_type}"/>"></li>
 						  <li><input type="text" class="form-control" id="delYN" name="delYN" placeholder="delYN"required value="<c:out value="${itme.delYN}"/>"></li>
